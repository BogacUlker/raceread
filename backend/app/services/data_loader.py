...
def load_calendar() -> list[dict]:
    """Load the season calendar (generated by scripts/fetch_calendar.py)."""
...
def load_classics() -> list[dict]:
    """Load the Classics shelf registry. Returns [] if not present."""
    path = DATA_DIR / "classics.json"
    if not path.exists():
        return []
    return load_json(str(path))
...
def load_standings() -> dict:
    """Load championship standings (generated by scripts/fetch_standings.py)."""
    return load_json(str(DATA_DIR / "standings.json"))
