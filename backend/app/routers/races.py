...
def get_classics() -> list[dict]:
    """Classics shelf - curated historic races (see backend/scripts/spice_score.py)."""
    return load_classics()


@router.get("/races/{race_id}/radio")
def get_radio(race_id: str) -> dict:
    """Team-radio clips matched to laps (generated by scripts/fetch_radio.py)."""
    try:
