...
<div class="pq">
	...
	<nav class="pq-nav">
		<div class="pq-nav__inner">
			<a href="/preview" class="pq-nav__logo">RACEREAD</a>
			...
			<div class="pq-sb__full">
				<div class="pq-sb__sec"><nav class="pq-sb__nav">
					{#each races as race, i}
						<a href="/preview/race/{race.id}" class="pq-sb__race"><span class="pq-sb__rc">R{i+1}</span><span class="pq-sb__rn">{race.circuit}</span></a>
					{/each}
				</nav></div>
				<div class="pq-sb__bottom"><a href="/preview/race/{raceId}" class="pq-sb__home">&larr; {gpName(raceInfo.name)}</a></div>
			</div>
			<div class="pq-sb__mini">
				{#each races as race, i}<a href="/preview/race/{race.id}" class="pq-sb__mr" style="border-left-color:{tc(race.winner)}">R{i+1}</a>{/each}
			</div>
		</aside>

		<!-- MAIN -->
		<div class="pq-main">
			<a href="/preview/race/{raceId}" class="pq-back">&larr; {gpName(raceInfo.name)}</a>
