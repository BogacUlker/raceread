	...
	<nav class="pd-nav">
		<div class="pd-nav__inner">
			<div class="pd-nav__left">
				...
				<a href="/preview" class="pd-nav__logo">RACEREAD</a>
			</div>
		...
		<aside class="pd-sb" class:collapsed={sidebarCollapsed}
			...
			<div class="pd-sb__full">
				...
				<div class="pd-sb__sec">
					<nav class="pd-sb__nav">
						{#each races as race, i}
							<a href="/preview/race/{race.id}" class="pd-sb__race" class:pd-sb__race--active={race.id === raceId}>
				...
				<div class="pd-sb__bottom">
					<a href="/preview" class="pd-sb__home">&larr; {$locale === 'tr' ? 'Ana Sayfa' : 'Home'}</a>
				</div>
			</div>
			<div class="pd-sb__mini">
				{#each races as race, i}
					<a href="/preview/race/{race.id}" class="pd-sb__mr" class:pd-sb__mr--active={race.id === raceId} title={race.name} style="border-left-color:{tc(race.winner)}">R{i+1}</a>
				{/each}
			</div>
		</aside>
