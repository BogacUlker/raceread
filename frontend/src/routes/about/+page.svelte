...
<style>
	...
	.ab__src { color: var(--text-primary); }
	.ab__disclaimer { margin-top: 1rem; font-family: var(--font-mono, monospace); font-size: 10.5px; line-height: 1.7; color: var(--text-muted); }
