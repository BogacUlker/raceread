...
<style>
	...
	.wip__hint { font-family: var(--font-mono); font-size: 10px; color: var(--text-muted); }
	...
	.wip__stlaps { font-size: 9.5px; font-weight: 500; opacity: .75; }
	...
	.wip__chartnote { margin: 4px 0 0; font-family: var(--font-mono); font-size: 9.5px; color: var(--text-muted); }
	...
	.wip__v .k { display: block; font-family: var(--font-mono); font-size: 9.5px; letter-spacing: .1em; text-transform: uppercase; color: var(--text-muted); }
	...
	.wip__v .s { display: block; font-family: var(--font-mono); font-size: 10px; color: var(--text-muted); margin-top: 3px; }
	.up { color: #22C55E; } .down { color: var(--accent-text); }
	.wip__assump { margin: 12px 0 0; font-family: var(--font-mono); font-size: 9.5px; color: var(--text-muted); line-height: 1.7; text-transform: uppercase; letter-spacing: .04em; }
