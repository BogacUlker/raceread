...
<style>
	.stc { background: var(--bg-secondary, #1A1D27); border: 1px solid var(--border, #2E3240); padding: 16px 18px; height: 100%; box-sizing: border-box; }
	...
	.stc__unit { font-family: var(--font-mono); font-size: 9px; color: var(--text-muted, #7D8794); letter-spacing: .08em; }
	...
	.stc__rank { color: var(--text-muted, #7D8794); font-size: 9px; }
	...
	.stc__lap { color: var(--text-muted, #7D8794); font-size: 9px; text-align: right; }
	.stc__foot { display: flex; gap: 14px; margin-top: 12px; padding-top: 10px; border-top: 1px solid var(--border, #2E3240); font-family: var(--font-mono); font-size: 9.5px; color: var(--text-muted, #7D8794); flex-wrap: wrap; }
	.stc__mini b { color: var(--text-secondary, #9CA3AF); font-weight: 500; }
